...
/**
 * Created by Steve on 11/15/2015.
 */
public class ChooserGameActivity extends Activity {

    private int nLevel = 1;   // max 7
        ...
        mGrid.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (l.isChecked()) {
                    ...
                    if (gameBoard[position] == 0) {  // 1 - green   0 - loser
                    ...
                    i.setBackgroundDrawable(getResources().getDrawable(R.drawable.yellowbackground));
                }
